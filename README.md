...
**Raviranjan Kumar**
- RTU Roll No: 23EACCS870
- Email: raviranjansh15@gmail.com
- GitHub: [RAVIRANJANKUMAR](https://github.com/Itzraviranjan123)
- LinkedIn: [Raviranjan-kumar](https://www.linkedin.com/in/raviranjan-kumar-432487424)
...
> **Note:** The original `.pbix` Power BI file is not included in this repository. Only the dataset and dashboard screenshots are provided. If you'd like to reproduce the dashboard, open `Online_Courses.csv` in Power BI Desktop and recreate the visuals shown in `images/`.
